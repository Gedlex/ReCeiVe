...
%----------------------------------------------------------------------------------------
\documentclass[rightPos]{modern-cv} % By default, use 'letterpaper' for US letter
...
\skillset{MATLAB/.9,Python/.5,VBA/.8,Java/.5,C++/.4}
...
\input{cvSections/compulsoryService.tex}
